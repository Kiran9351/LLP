;;Assembly program to print addition of numbers by receiving numbers via command line arguments
...
main:
	...
	mov ebp,esp		;;saving stack pointer in ebp
	
	mov ecx,[ebp+8]		;;copying argc
	cmp ecx,2		;;checking if values are given after ./a.out
	jb insuff		;;print insufficient if no arguments are passed
...
lp:
	...
	call atoi		;;calloing atoi to convert "10" into 10
	add esp,4		;;result of this operation eax = atoi(argv[i])
	pop edx			;;retrieving edx value which has changed due to call atoi
